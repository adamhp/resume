...
\begin{itemize}[leftmargin=0pt]
  ...
  \item[]{\faLink\space \href{https://github.com/adamhp/5e-spell-search}{\intersemibold{https://github.com/adamhp/5e-spell-search}}}: An ObsidianMD plugin written in TypeScript that imports 5e.tools data and indexes it with Lucene for searching Dungeons and Dragons Fifth Edition information.  \\
